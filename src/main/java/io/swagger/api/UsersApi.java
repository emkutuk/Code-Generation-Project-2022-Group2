...
public interface UsersApi
{
    ...
    @Operation(summary = "Gets logged in user.", description = "", security = {@SecurityRequirement(name = "bearerAuth")}, tags = {"User"})
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Logged in user.")})
